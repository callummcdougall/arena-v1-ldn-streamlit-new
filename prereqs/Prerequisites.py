...
<ul class="contents">
    ...
    <li><ul class="contents">
        ...
        <li><a class="contents-el" href="#numpy"></a></li>
...
Throughout this document, there are some questions peppered in, which will be indicated by **red font**. You should be able to answer all of these questions, once you’ve read through the relevant material.
...
[https://lh5.googleusercontent.com/uZJWOpSE8RNFOZIKHzCf_N3pJ3GMKczvWW9lQHZhmSPN04cG1ZccXQvgK9yEFyk4tDUZNs3oxuNaGihmwjzglZr5VpAx7zL-ASLlw3_EDVzZT7oR-PF_BfsPxiN_4Z_FTy1zDy8-Y3LN9jBX6f-LvjUSfm8NJjbEEAhcVSvxr7ibLFIcVeknys88RA](https://lh5.googleusercontent.com/uZJWOpSE8RNFOZIKHzCf_N3pJ3GMKczvWW9lQHZhmSPN04cG1ZccXQvgK9yEFyk4tDUZNs3oxuNaGihmwjzglZr5VpAx7zL-ASLlw3_EDVzZT7oR-PF_BfsPxiN_4Z_FTy1zDy8-Y3LN9jBX6f-LvjUSfm8NJjbEEAhcVSvxr7ibLFIcVeknys88RA)
...
**What is the expected value and variance of the sum of two normally distributed random variables $X_1 \sim N(\mu_1, \sigma_1^2)$ and $X_1 \sim N(\mu_2, \sigma_2^2)$? Can you prove this mathematically?**
...
- **Shortcuts**
    ...
    Here are a list of particularly useful ones. You can see how they all work in more detail [here](https://www.geeksforgeeks.org/visual-studio-code-shortcuts-for-windows-and-mac/).
    
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/2f2a2141-c782-4fbb-bbf4-04fa97d9d88f/Untitled.png)
...
[https://lh3.googleusercontent.com/8b1mRtlgLFgEl0mFvpkhgdUh8etYiJAKgllHWMXOqSnP25FrYcJCteks4LtLRgbHF0syMbhgjHGRXsn8dXWhkVwLKowpDoQ1rupWN0h2l59dYqERr800aLoGzw9Yw2IBfqPBSm_eBBMp8UZBETfpEiQXzyUeCWyxJ-BwcwVPCkMMjbY_EueZPxAqnQ](https://lh3.googleusercontent.com/8b1mRtlgLFgEl0mFvpkhgdUh8etYiJAKgllHWMXOqSnP25FrYcJCteks4LtLRgbHF0syMbhgjHGRXsn8dXWhkVwLKowpDoQ1rupWN0h2l59dYqERr800aLoGzw9Yw2IBfqPBSm_eBBMp8UZBETfpEiQXzyUeCWyxJ-BwcwVPCkMMjbY_EueZPxAqnQ)
