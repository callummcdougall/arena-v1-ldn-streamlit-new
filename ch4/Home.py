...
def page():
    st_image("headers/rl.png", width=320)
...
In this chapter, you will be learning about some of the fundamentals of RL, and working with OpenAI’s [Gym](https://github.com/openai/gym) environment to run your own experiments.

Some highlights from this chapter include:

* Implementing the multi-armed bandit problem
* Studying the Bellman equation, and its relevance for RL
* Implementing Q-learning and DQN
* Building Actor-Critic networks and PPO
""")
