...
def section1():
    ...
    * [An Interactive Guide To The Fourier Transform](https://betterexplained.com/articles/an-interactive-guide-to-the-fourier-transform/)
    ...
    st.image("w0d1/images/ani1.png")

    # st.info("""
    # Note - if you run this function but only get empty output, this might mean you need to downgrade some packages to earlier versions. Running the following should work:
    ...
    # You may also have to downgrade to Python version `3.9`, if you're using `3.10`. If you're using `conda`, you can set up a virtual environment using `conda create -n myenv python=3.9`.
    # """)
    ...
    * Linear combinations of trig terms, e.g. $\sin{3x} + \cos{17x}$. What do you expect to see in these cases?
    ...
    with st.expander("Explanation for sin(3x) + cos(17x)"):
        ...
        """)
        st.image("w0d1/images/ani1a.png")
        st.image("w0d1/images/ani1b.png")
        st.image("w0d1/images/ani1c.png")
...
def section2():
    ...
    st.image("w0d1/images/diagram.png")
